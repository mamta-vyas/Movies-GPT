...
const VideoTitle = ({title, overview}) => {
  return (
    <div className="w-screen aspect-video pt-[40%] md:pt-[20%] px-6 md:px-36 absolute text-white bg-gradient-to-r from-black">
    <h1 className='text-sm md:text-6xl'>{title}</h1>
      <p className='hidden md:inline-block text-xl py-6 w-1/4'>{overview}</p>
